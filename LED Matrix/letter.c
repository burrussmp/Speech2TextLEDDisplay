...
struct letter* createLetter(char l)
{
  ...
  switch(l)
  {
    ...
    case '+':
        ...
        newLetter->pixelMatrix[0][3] = 2;
        newLetter->pixelMatrix[0][4] = 2;
        newLetter->pixelMatrix[1][2] = 2;
        newLetter->pixelMatrix[1][3] = 2;
        newLetter->pixelMatrix[1][4] = 2;
        newLetter->pixelMatrix[2][2] = 2;
        newLetter->pixelMatrix[2][3] = 2;
        newLetter->pixelMatrix[2][4] = 2;
        break;
    case '2':
        letter_init(newLetter,6,6);
        newLetter->pixelMatrix[1][1] = 1;
